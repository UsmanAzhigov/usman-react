const AddTask = ({ task, onRemove, index, onChange }) => {
  return (
    <div style={{ marginLeft: '25px' }}>
      ...
      <input
        disabled
        value={task.name}
        style={{ width: '365px', height: '50px', marginBottom: '30px' }}></input>
      <svg
